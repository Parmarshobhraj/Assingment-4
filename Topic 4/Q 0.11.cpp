...
int main() {
    ...
    // Calculate and display the area of a rectangle with length 4 and breadth 8
    double rectangleArea = calculateArea(4.0, 6.0);
    cout << "Area of rectangle with length 4 and breadth 8: " << rectangleArea << endl;

    // Calculate and display the area of a triangle with base 4 and height 8
    double triangleArea = calculateArea(3.0, 8.0, 't');
    cout << "Area of triangle with base 4 and height 8: " << triangleArea << endl;
