...
int main() {
    ...
    // Perform addition
    cout << "Addition (int): " << math.operate(5, 5) << endl;
    cout << "Addition (float): " << math.operate(5.5f, 5.5f) << endl;

    // Perform subtraction
    cout << "Subtraction (int): " << math.operate(10, 2, 2) << endl;
    cout << "Subtraction (float): " << math.operate(10.5f, 2.2f, 2.1f) << endl;

    // Perform multiplication
    cout << "Multiplication (int): " << math.operate(2, 5, 4, 5) << endl;
    cout << "Multiplication (float): " << math.operate(2.5f, 5.5f, 4.5f, 5.5f) << endl;
