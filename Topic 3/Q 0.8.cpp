...
int main() {
   // Create an Address object for each student
    Address address1("Srusti complex","Ahemdabad","Gujrat", "380018");
    Address address2("1150 Luharsheri", "Ahemdabad", "Gujrat", "380018");

    // Create Student objects with name, class, roll number, marks, and address
    Student student1("Sujal Patel", "Class XI", 101, 85, address1);
    Student student2("Shobhraj Parmar", "Class XII", 102, 95, address2);
